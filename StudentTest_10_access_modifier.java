class StudentTest_10_access_modifier{
    ...
    public static void main(String[] args){
        ...
        student_10_access_modifier student1 = new student_10_access_modifier(studnetIds[0], "joan", "male");
        


        student_10_access_modifier student2 = new student_10_access_modifier(studnetIds[1], "raj", "male");

        student_10_access_modifier student3 = new student_10_access_modifier(studnetIds[2], "anita", "female ");
